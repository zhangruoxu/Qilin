...
def genDocHeadPart():
    headPart = [r"\documentclass{article}",
                ...
                r"\newcommand{\turnerobj}[1]{\textsc{T-#1obj}\xspace}",
                ...
                r"\newcommand{\conchobj}[1]{\textsc{$#1$obj+D}\xspace}",
                r"\newcommand{\conchEobj}[1]{\textsc{E$#1$obj+D}\xspace}",
                r"\newcommand{\conchZobj}[1]{\textsc{Z$#1$obj+D}\xspace}",
